...
assert.match(html,/data-release="v16"/,'historical v16 shell retains its consequence layer');
assert.match(html,/trg-v15\.css\?v=15\.0\.0-rc1/,'historical v16 loads v15 CSS');
assert.match(html,/trg-v15-impact\.js\?v=15\.0\.0-rc1/,'historical v16 loads v15 impact controller');
...
console.log('Historical v15 impact contract passed.');
